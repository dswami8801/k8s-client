...
import com.fico.k8s.core.http.DELETE;
import com.fico.k8s.core.http.GET;
import com.fico.k8s.core.http.HEAD;
import com.fico.k8s.core.http.HTTP;
import com.fico.k8s.core.http.OPTIONS;
import com.fico.k8s.core.http.POST;
import com.fico.k8s.core.http.PUT;
...
public class MutateService {
	...
	static class Builder {
		...
		private void parseMethodAnnotation(Annotation annotation) {
			...
			} else if (annotation instanceof com.fico.k8s.core.http.Headers) {
				String[] headersToParse = ((com.fico.k8s.core.http.Headers) annotation).value();
